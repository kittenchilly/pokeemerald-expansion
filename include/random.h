...
enum RandomTag
{
    ...
    RNG_APPRENTICE_ID,
    RNG_APPRENTICE_QUESTION_MON,
    RNG_APPRENTICE_QUESTION_DATA,
    RNG_APPRENTICE_QUESTION_MOVE,
    RNG_AI_CONSIDERED_MOVES_SINGLES,
    RNG_AI_CONSIDERED_MOVES_DOUBLES,
    RNG_AI_CONSIDERED_TARGETS_DOUBLES,
    RNG_AI_CHECKBADMOVE_PROTECT,
    RNG_AI_RISKY_HIT_ALLSTATSUP,
    RNG_AI_SAFARI,
    RNG_AI_SWITCH_SE_OFFENSIVE,
    RNG_AI_SWITCH_BEST_WITH_BATON_PASS,
    RNG_AI_SWITCH_FROM_BATON_PASS,
    RNG_AI_LESS_THAN,
    RNG_AI_OHKO_FOCUS_BAND,
    RNG_AI_OHKO_TEST_ODDS,
    RNG_AI_PROTECT_CHECKS,
    RNG_AI_ABSORB,
    RNG_AI_RECOVER,
};
