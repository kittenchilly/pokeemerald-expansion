const struct BattleMove gBattleMoves[MOVES_COUNT_Z] =
{
    ...
    [MOVE_RAZOR_WIND] =
    {
        ...
        .pp = 10,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_ALL_ADJACENT_FOES,
        .priority = 0,
        .split = SPLIT_SPECIAL,
        .zMoveEffect = Z_EFFECT_NONE,
        .highCritRatio = TRUE,
    ...
    [MOVE_THRASH] =
    {
        ...
        .accuracy = 100,
        .secondaryEffectChance = 100,
        .target = MOVE_TARGET_RANDOM_NORMAL,
        .priority = 0,
        .split = SPLIT_PHYSICAL,
        .zMoveEffect = Z_EFFECT_NONE,
        .makesContact = TRUE,
    ...
    {
        #if B_UPDATED_MOVE_DATA >= GEN_4
            .target = MOVE_TARGET_ADJACENT_ALLY,
        #else
            .target = MOVE_TARGET_SELF,
        #endif
    ...
    [MOVE_ACUPRESSURE] =
    {
        ...
        .pp = 30,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELF | MOVE_TARGET_ADJACENT_ALLY,
        .priority = 0,
        .split = SPLIT_STATUS,
        .zMoveEffect = Z_EFFECT_BOOST_CRITS,
        .ignoresProtect = TRUE,
    ...
    [MOVE_DOODLE] =
    {
        ...
        .pp = 10,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_ALL_ADJACENT, // Supposedly unconfirmed?
