...
static const u16 sKoraidonFormSpeciesIdTable[] = {
    SPECIES_KORAIDON_APEX,
    SPECIES_KORAIDON_LIMITED,
    SPECIES_KORAIDON_SPRINTING,
    SPECIES_KORAIDON_SWIMMING,
    SPECIES_KORAIDON_GLIDING,
    FORM_SPECIES_END,
};
#endif //P_FAMILY_KORAIDON

#if P_FAMILY_MIRAIDON
static const u16 sMiraidonFormSpeciesIdTable[] = {
    SPECIES_MIRAIDON_ULTIMATE,
    SPECIES_MIRAIDON_LOW_POWER,
    SPECIES_MIRAIDON_DRIVE,
    SPECIES_MIRAIDON_AQUATIC,
    SPECIES_MIRAIDON_GLIDE,
    FORM_SPECIES_END,
};
