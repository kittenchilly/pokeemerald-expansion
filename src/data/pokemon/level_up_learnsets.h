...
static const struct LevelUpMove sPalafinZeroFormLevelUpLearnset[] = {
...
static const struct LevelUpMove sGimmighoulChestFormLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sIronLeavesLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(63, MOVE_PSYBLADE),
    LEVEL_UP_MOVE(70, MOVE_IMPRISON),
    LEVEL_UP_MOVE(77, MOVE_MEGAHORN),
...
#if P_GEN_9_POKEMON == TRUE
static const struct LevelUpMove sPaldeanTaurosCombatBreedLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_WORK_UP),
    LEVEL_UP_MOVE(10, MOVE_DOUBLE_KICK),
...
static const struct LevelUpMove sPaldeanTaurosBlazeBreedLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_WORK_UP),
    LEVEL_UP_MOVE(10, MOVE_DOUBLE_KICK),
...
static const struct LevelUpMove sPaldeanTaurosAquaBreedLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 5, MOVE_WORK_UP),
    LEVEL_UP_MOVE(10, MOVE_DOUBLE_KICK),
...
static const struct LevelUpMove sPaldeanWooperLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_MUD_SHOT),
    LEVEL_UP_MOVE( 4, MOVE_TACKLE),
